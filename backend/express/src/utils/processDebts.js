...
export const processDebts = async () => {
  ...
  for (const debt of activeDebts) {
    try {
      ...
      // Expire debt if duration completed
      ...
      // SIMPLE INTEREST CALCULATION (as you designed)
